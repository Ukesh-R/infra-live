...
source = "../../../modules/iam/aws-iam"
cluster_name =  var.cluster_name
role_name = "staging-eks-cluster-role"
...
source = "../../../modules/iam/aws-iam"
cluster_name= var.cluster_name
role_name = "staging-eks-node-role"
service = "ec2.amazonaws.com"
managed_policy_arns = [
...
source = "../../../modules/iam/aws-iam"
cluster_name = var.cluster_name
role_name = "staging-github-actions-role"
is_github_role = true
