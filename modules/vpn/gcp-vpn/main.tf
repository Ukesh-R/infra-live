resource "google_compute_ha_vpn_gateway" "gcp-vpn-gateway" {
...
resource "google_compute_forwarding_rule" "vpn-udp500" {
  name        = "vpn-udp500"
  region_name      = var.region_name
  ip_protocol = "UDP"
  port_range  = "500"
...
resource "google_compute_forwarding_rule" "vpn-udp4500" {
  name        = "vpn-udp4500"
  region_name      = var.region_name
  ip_protocol = "UDP"
  port_range  = "4500"
